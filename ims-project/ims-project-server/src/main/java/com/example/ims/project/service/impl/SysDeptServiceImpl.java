...
import com.example.ims.project.api.entity.SysDeptRelation;
import com.example.ims.project.dto.DeptTree;
import com.example.ims.project.mapper.SysDeptMapper;
import com.example.ims.project.service.SysDeptRelationService;
import com.example.ims.project.service.SysDeptService;
...
public class SysDeptServiceImpl extends ServiceImpl<SysDeptMapper, SysDept> implements SysDeptService {
	...
	public List<DeptTree> listCurrentUserDeptTrees() {
		List<Integer> descendantIdList = sysDeptRelationService
			.list(Wrappers.<SysDeptRelation>query().lambda()
				.eq(SysDeptRelation::getAncestor, "1"))
